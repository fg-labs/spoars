...
### Does this change alignment output?

- [ ] Yes — and I have updated/added parity tests and explained why the change is correct
- [ ] No — output is bit-identical (parity vs `SisdEngine`/the C++ oracle is unchanged)

<!-- Faithfulness to spoa is the core contract: any change to the DP fill, tie-breaks, consensus, MSA, or GFA/DOT must be justified and covered by parity tests. -->
