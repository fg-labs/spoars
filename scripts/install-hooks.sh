#!/bin/bash
#
# Install git hooks for spoars development
#
...
echo "Installing git hooks for spoars..."

# Verify we're in the right place
if [[ ! -f "${REPO_ROOT}/Cargo.toml" ]]; then
    echo "Error: Must be run from the spoars repository"
    exit 1
fi
...
echo "  SPOARS_PRECOMMIT_TEST=1 git commit"
echo ""
