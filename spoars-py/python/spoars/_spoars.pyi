...
class Poa:
    ...
    def encode(self, base: str) -> int | None: ...
    def decode(self, code: int) -> str | None: ...
    def rank_order(self) -> list[int]: ...
    def sequence_starts(self) -> list[int]: ...
    def sequence_path(self, seq_index: int) -> list[int]: ...
    def consensus_nodes(self) -> list[int]: ...
    def node_code(self, node_id: int) -> int: ...
    def node_coverage(self, node_id: int) -> int: ...
    def node_base(self, node_id: int) -> str | None: ...
    def node_successor(self, node_id: int, label: int) -> int | None: ...
    def node_labels(self, node_id: int) -> list[int]: ...
    def edges(self) -> list[tuple[int, int, int]]: ...
    def msa_columns(self) -> tuple[list[int], int]: ...
    def column_members(self) -> list[list[tuple[int, int]]]: ...
